                                            ...
                                            if field.Name = 'SellerParty' then begin
                                                if field.HasAttributes() then begin
                                                    foreach Attr in field.Attributes() do begin
                                                        ...
                                                        case Attr.Name of
                                                            'context':
                                                                if attributeValue = 'partner' then
                                                                    if field.Name = 'PartyCode' then
                                                                        Data."Seller Party Code" := field.InnerText;
                                                        end;
                                                    end;
                                                end;
                                                foreach fieldnode in field.GetChildNodes() do
                                                        ...
                                                        foreach Attr in field.Attributes() do begin
                                                            ...
                                                            case Attr.Name of
                                                                'context':
                                                                    if attributeValue = 'partner' then
                                                                        if field.Name = 'PartyCode' then
                                                                            Data."Buyer Party Code" := field.InnerText;
                                                            end;
                                                        end;
                                                    end;
                                                    foreach fieldnode in field.GetChildNodes() do
                                            ...
                                            foreach fieldnode in e.GetChildNodes() do begin
                                                ...
                                                if e.HasElements() then
                                                    foreach fieldnode in e.GetChildNodes() do begin
                                                        if fieldnode.IsXmlElement() then begin
                                                            field := fieldnode.AsXmlElement();
                                                            if field.Name = 'DocumentItem' then
                                                                foreach fieldnode in field.GetChildNodes() do
                                                                    if fieldnode.IsXmlElement() then begin
                                                                        field := fieldnode.AsXmlElement();
                                                                        if field.Name = 'ItemEntry' then
                                                                            foreach fieldnode in field.GetChildNodes() do
                                                                                if fieldnode.IsXmlElement() then begin
                                                                                    field := fieldnode.AsXmlElement();
                                                                                    case field.Name of
